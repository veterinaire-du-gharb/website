(function () {
      ...
      <footer class="site-footer">
        <div class="container">
          <div class="footer-grid">
            ...
            <div><div class="footer-title">Horaires</div><div class="hours-list"><div class="hours-line"><span>Lun – Ven</span><strong>09:00 – 12:30 et 15:00 - 19:30</strong></div><div class="hours-line"><span>Samedi</span><strong>09:00 – 12:30 et 15:00 - 17:00</strong></div><div class="hours-line"><span>Dimanche</span><strong>Urgences</strong></div></div></div>
  ...
  function contactPage() {
    return `<main id="main-content">${pageHero("Nous trouver", "Contact", "Une question, un rendez-vous à confirmer ou une urgence ? Choisissez le moyen le plus direct pour joindre l'équipe.", "Avant de vous déplacer", "En cas d'urgence, appelez afin que nous puissions préparer votre arrivée.")}<section class="form-section"><div class="container contact-layout"><div class="map-card" data-map-container><div class="map-consent"><span class="map-pin">${icon("mapPin")}</span><div><strong>Carte Google Maps</strong><p>La carte est bloquée pour protéger votre vie privée. En l'affichant, vous autorisez le chargement de contenu depuis Google.</p><button class="btn btn-primary" type="button" data-map-consent>Autoriser et afficher la carte</button><a class="text-link map-fallback-link" href="${CONTACT.map}" target="_blank" rel="noopener">Ouvrir l'itinéraire sans intégrer la carte ${icon("arrow")}</a></div></div></div><aside class="contact-panel"><span class="eyebrow">Clinique du Gharb</span><h2>À Kénitra, au cœur de la ville.</h2><div class="contact-detail">${icon("mapPin")}<span><small>Adresse</small><strong>${CONTACT.address}</strong></span></div><div class="contact-detail">${icon("phone")}<span><small>Téléphone</small><strong><a href="tel:${CONTACT.tel}">${CONTACT.phone}</a></strong></span></div><div class="contact-detail">${icon("mail")}<span><small>E-mail</small><strong><a href="mailto:${CONTACT.email}">${CONTACT.email}</a></strong></span></div><div class="contact-detail" id="horaires">${icon("clock")}<span><small>Horaires</small><strong>Lun–Ven : 09:00–12:30 et 15:00-19:30<br>Sam : 09:00–12:30 et 15:00-17:00<br>Dim : urgences sur appel</strong></span></div><a class="btn btn-urgent btn-block" href="tel:${CONTACT.tel}">${icon("phone")} Appeler la clinique</a><a class="btn btn-primary btn-block" href="rendez-vous.html">Prendre rendez-vous</a></aside></div></section></main>`;
  }
